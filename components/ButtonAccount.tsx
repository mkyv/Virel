...
const ButtonAccount = () => {
	...
	const handleSignOut = async () => {
		...
		// Reload at the current path so next-intl's middleware redirects to
		// the locale-prefixed root (e.g. /es or /en) instead of a bare /.
	...
	const handleBilling = async () => {
		...
		try {
			// LemonSqueezy customer portal devuelve una URL fija por customer;
			// no acepta returnUrl, así que no lo enviamos.
