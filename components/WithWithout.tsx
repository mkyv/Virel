// Componente útil cuando tu producto desafía el status quo.
// Izquierda: pains del usuario sin tu producto. Derecha: cómo tu producto los resuelve.
// Intentá emparejar línea por línea para que la comparación sea visual.
const WithWithout = () => {
  return (
