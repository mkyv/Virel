...
// Wall-of-love with 3 testimonials. Replace the list below with real ones.
// To bring back avatars, add an `img` property pointing to a local /public asset
// (recommended) or an external URL.
const list: {
  username?: string;
  name: string;
  text: string;
  ...
  {
    name: "Jane Doe",
    text: "Replace this quote with a real customer testimonial focused on the outcome they got.",
  },
  {
    name: "John Smith",
    text: "Keep quotes specific and short. Mention the pain point and how it was solved.",
  },
  {
    name: "Alex Martin",
    text: "Real names + roles build trust. Link the quote to a public profile when possible.",
  },
];
