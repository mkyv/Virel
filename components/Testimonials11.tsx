...
// Placeholder testimonials. The grid needs 11 items.
// The last one (index 10) is featured on large screens (spans 2 cols + bigger font).
// To bring back avatars, add an `img` property pointing to a local /public asset.
// To show video testimonials, set `type: refTypes.video` and fill `videoSrc` / `videoPoster`.
const list: {
  username?: string;
  name: string;
  text: string;
  ...
  {
    name: "Jane Doe",
    text: "Replace with a real customer quote — short, specific, outcome-focused.",
    type: refTypes.other,
  },
  {
    name: "John Smith",
    text: "Quotes from real users with their name and role build more trust than anonymous ones.",
    type: refTypes.other,
  },
  {
    name: "Alex Martin",
    text: "Aim for a mix of one-liners and slightly longer testimonials to keep the wall visually balanced.",
    type: refTypes.other,
  },
  {
    name: "Sam Patel",
    text: "Once you have a real link to the testimonial (tweet, PH review), add it to `link` and set `type` accordingly.",
    type: refTypes.other,
  },
  {
    name: "Robin Lee",
    text: "Highlight the specific outcome the customer got — saved time, money, headaches, etc.",
    type: refTypes.other,
  },
  {
    name: "Casey Brown",
    text: "Keep the writing natural. Long, polished testimonials feel scripted.",
    type: refTypes.other,
  },
  {
    name: "Jordan Kim",
    text: "Try to vary the angles: speed, ease, results, integration, support.",
    type: refTypes.other,
  },
  {
    name: "Morgan Diaz",
    text: "If you have a video testimonial, swap `type` to `refTypes.video` and fill the video fields.",
    type: refTypes.other,
  },
  {
    name: "Taylor Reed",
    text: "Anonymous quotes are fine for early traction. Replace as soon as you have real names.",
    type: refTypes.other,
  },
  {
    name: "Riley Nguyen",
    text: "Twitter / Product Hunt links boost credibility — re-enable `refTypes.twitter` or `refTypes.productHunt` when you have them.",
    type: refTypes.other,
  },
  // Featured on big screens (spans 2 cols + bigger font) 👇
  {
    name: "Sasha Khan",
    text: "The featured testimonial should be your strongest, most specific quote. Use it to drive the value proposition home.",
    type: refTypes.other,
  },
];
      ...
      <div className="py-24 px-8 max-w-7xl mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-base-content/80">
            What people are saying about {config.appName}.
          </p>
        </div>
