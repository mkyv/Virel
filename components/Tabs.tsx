...
// Tabs component: switches content based on the active tab.
// Replace the items below with the project's actual tabs (plans comparison,
// device showcase, feature breakdown, etc.). `icon` is optional.
...
const tabs: Tab[] = [
	{
		...
		content: (
			<div className="space-y-2">
				<p>
					<strong>Heading:</strong> Replace with the first tab&apos;s content.
				</p>
				<p>
					Each tab can render anything: text, lists, images, tables, embedded
					components.
				</p>
			</div>
		),
	},
	{
		...
		content: (
			<div className="space-y-2">
				<p>
					<strong>Heading:</strong> Replace with the second tab&apos;s content.
				</p>
				<p>
					Use this pattern for plan comparisons, device showcases, feature
					breakdowns, or anything that benefits from grouped views.
				</p>
			</div>
		),
	},
	{
		...
		content: (
			<div className="space-y-2">
				<p>
					<strong>Heading:</strong> Replace with the third tab&apos;s content.
				</p>
				<p>
					Add or remove tabs by editing the `tabs` array at the top of this
					file. The grid auto-sizes to the number of items.
				</p>
			</div>
		),
	},
