...
// Bento-style grid of 4 features with mock UI demos.
// Each item declares its own `demo` JSX so you can craft a custom visual per feature.
// Replace titles, descriptions and demo content with what the product actually does.
const features = [
  {
    title: "Feature one",
    description:
      "Short, outcome-driven description for the first feature card.",
  ...
  },
  {
    title: "Feature two",
    description:
      "Wider card. Useful for showing a list, ranking or table-like data.",
    ...
    demo: (
      <div className="px-6 max-w-[600px] flex flex-col gap-4 overflow-hidden">
        {[
          {
            text: "Top-voted item",
            secondaryText: "Shipping this ✅",
            votes: 48,
            transition: "group-hover:-mt-36 group-hover:md:-mt-28 duration-500",
          },
          {
            text: "Second item",
            secondaryText: "Considering 🤔",
            votes: 12,
          },
          {
            text: "Third item",
            secondaryText: "Not shipping ❌",
            votes: 1,
          },
        ].map((feature, i) => (
          <div
  ...
  },
  {
    title: "Feature three",
    description:
      "Another wide card. Could showcase themes, customization or a gallery.",
            ...
            <div className={theme.css} key={i}>
              ...
              <div className="space-y-2">
                <div className="p-4 bg-base-100 rounded-box flex justify-between">
                  <div>
                    <p className="font-semibold mb-1">Item A</p>
                    <p className="opacity-80">Short subtitle</p>
                  </div>
                  <button
                ...
                <div className="p-4 bg-base-100 rounded-box flex justify-between ">
                  <div>
                    <p className="font-semibold mb-1">Item B</p>
                    <p className="opacity-80">Short subtitle</p>
                  </div>
                  <button
                    className={`px-4 py-2 rounded-box group text-center text-lg duration-150 border border-transparent ${theme.buttonStyles}`}
  ...
  },
  {
    title: "Feature four",
    description:
      "A discussion or feedback-style card with replies.",
    ...
    demo: (
      <div className="text-neutral-content px-6 space-y-4">
        {[
          {
            id: 1,
            text: "An example question or request from a user.",
            userInitial: "J",
            userName: "Jane Doe",
          ...
          {
            id: 2,
            text: "A reply showing engagement and validation.",
            userInitial: "S",
            userName: "Sam Patel",
            ...
            <div className="text-neutral/80 flex items-center gap-2 text-sm">
              <div className="flex items-center gap-2">
                <div className="avatar">
                  <div className="w-7 rounded-full bg-base-300 flex items-center justify-center text-xs font-semibold text-base-content">
                    {reply.userInitial}
                  </div>
                </div>
    ...
    <section className="flex justify-center items-center w-full bg-base-200/50 text-base-content py-20 lg:py-32">
      <div className="flex flex-col max-w-[82rem] gap-16 md:gap-20 px-4">
        <h2 className="max-w-3xl font-black text-4xl md:text-6xl tracking-[-0.01em]">
          Headline about <br /> the value you{" "}
